...
const DolarOficialFetch = props => {
  //Uso de la herramienta de fetching.
  const [{ data, isLoading, isError }] = useDataApi(
    `https://apis.datos.gob.ar/series/api/series/?ids=168.1_T_CAMBIOR_D_0_0_26&start_date=${getFecha()}&metadata=none&limit=15&format=json`, //URL a fetchear.
      ...
      {isLoading ? (
        ...
        <Loading text="Obteniendo Datos..." variant="h3" />
          ...
          <Fragment>{(data.data !== undefined ?
            ...
            x={1024}
            y={400}
            sidelabel="Precio del Dolar en Pesos"
            simbol="$"
            textbar="Precio del Dolar"
            />
...
export default DolarOficialFetch;